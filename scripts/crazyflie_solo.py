...
def loggingcsv(data):
    ...
    nama_file = 'data.csv'
    with open("/home/dryan/Desktop/Rabu294/logCF.csv", "w") as file:
...
if __name__ == "__main__":
    ...
    with SyncCrazyflie(uri, cf=Crazyflie(rw_cache='./cache')) as scf:
        ...
        with PositionHlCommander(
            ...
            # Terbang WP semua
            pc.go_to(5.5, -0.5, velocity=None)
            pc.go_to(5.0, -1.5, velocity=None)

            pc.go_to(0.5, -1.5, velocity=None)
            pc.go_to(0.5, -2.5, velocity=None)

            pc.go_to(5.0, -2.5, velocity=None)
            pc.go_to(4.5, -3.5, velocity=None)

            pc.go_to(0.8, -3.3, velocity=None)
