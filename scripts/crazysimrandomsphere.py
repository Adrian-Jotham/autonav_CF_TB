...
def calculate_intensity(x, y, z, sources):
    ...
    for (source_x, source_y, source_z) in sources:
        ...
        intensity = max(0, 10 - distance * 5)  # Adjusted calculation for 3D distance
...
if __name__ == '__main__':
    try:
        ...
        sources = [(3.13 - offset, -3.18 + offset, 0.8), (0.1 - offset, -3.4 + offset, 0.8)]
        then = rospy.get_time()
        time.sleep(3)

        coordinates = [
            (0, 0, 0.8), (0, -1, 0.8), (0, -2, 0.8), (0, -3, 0.8),
            (1, 0, 0.8), (1, -1, 0.8), (1, -2, 0.8), (1, -3, 0.8), (1, -3.5, 0.8),
            (2, 0, 0.8), (2, -1, 0.8), (2, -2, 0.8), (2, -3, 0.8), (2, -4, 0.8),
            (3, 0, 0.8), (3, -1, 0.8), (3, -3.4, 0.8), (3, -4, 0.8), (3, -5, 0.8),
            (4, 0, 0.8), (4, -1, 0.8), (4, -2, 0.8), (4, -3, 0.8), (4, -4, 0.8),
            (5, 0, 0.8), (5, -1, 0.8),
        ]

        last_x, last_y, last_z = coordinates[0]
        visited_coords = set()
        visited_coords.add((last_x, last_y, last_z))
        ...
        while not rospy.is_shutdown():
            ...
            create_moving_marker(last_x, last_y, last_z, next_coord[0], next_coord[1], next_coord[2])
            last_x, last_y, last_z = next_coord
