...
if __name__ == '__main__':
    try:
        ...
        create_moving_marker(0, 0, 0.8, 5.5, -0.5, 0.8)
        create_moving_marker(last_x, last_y, last_z, 5.0, -1.5, 0.8)

        create_moving_marker(last_x, last_y, last_z, 0.5, -1.5, 0.8)
        create_moving_marker(last_x, last_y, last_z, 0.5, -2.5, 0.8)

        create_moving_marker(last_x, last_y, last_z, 5.0, -2.5, 0.8)
        create_moving_marker(last_x, last_y, last_z, 4.5, -3.5, 0.8)

        create_moving_marker(last_x, last_y, last_z, 0.8, -3.3, 0.8)
        create_moving_marker(last_x, last_y, last_z, 4.0, -5.0, 0.8)
